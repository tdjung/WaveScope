...
# Shared data model lives in profdata (the default engine
# must not depend on this frozen legacy module); names are
# re-exported here for backward compatibility.
from .profdata import (EVENTS, E_IR, E_DR, E_DW, E_BC, E_BI,
                       E_BIM, E_CY, N_EVENTS, CallSite, Profile)
